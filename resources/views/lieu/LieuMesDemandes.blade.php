                ...
                <div class="card bg-light mb-3">
                    <div class="card-body">
                        <div class="table-responsive">
                            ...
                            <p><i class="bi bi-info-square-fill text-success fs-3 me-2"></i>Les Parents et les Tuteurs attendent vos validations pour confirmer leurs réservations.</p>
                                                ...
                                                <td>
                                                    ...
                                                    <form
                                                        ...
                                                        <button type="submit" class="btn btn-danger col-md-6"
                                                            onClick="return confirm('Vous êtes sûr(e)?');">Annuler</button>
                                                    </form>
                                                </td>
                                            @endif
                                        </tr>
